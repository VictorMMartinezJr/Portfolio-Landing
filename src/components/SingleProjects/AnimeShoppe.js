    ...
    return (
        <section className='single-project'>
            ...
            <div className='project-headers'>
                ...
                <MainButton link='https://anime-shoppe.netlify.app/' text='LIVE SITE' type='main-btn secondary-btn' />
            ...
            <div ref={featuresSection} className='single-project-features'>
                ...
                <div className='feature-with-photo'>
                    ...
                    <img className='feature-img' src={animeShoppeData.LoadMore.image} alt="animeshoppe-loadmore" />
                </div>
                <div className='feature-no-photo'>
                ...
                <div className='feature-with-photo'>
                    ...
                    <img className='feature-img' src={animeShoppeData.Products.image} alt="animeshoppe-products" />
                </div>
                <div className='feature-with-photo'>
                    <div className='feature-with-photo-info'>
                    ...
                    <img className='feature-img' src={animeShoppeData.Cart.image} alt="animeshoppe-cart" />
                </div>
                <div className='feature-no-photo'>
