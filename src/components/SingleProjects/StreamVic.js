        ...
        <section className='single-project'>
            ...
            <div ref={featuresSection} className='single-project-features'>
                ...
                <div className='feature-with-photo'>
                    ...
                    <img className='feature-img' src={streamVicData.Pagination.image} alt="streamvic-pagination" />
                </div>
                <div className='feature-no-photo'>
                ...
                <div className='feature-with-photo'>
                    ...
                    <img className='feature-img' src={streamVicData.Search.image} alt="streamvic-search" />
                </div>
                <div className='feature-with-photo'>
                    <div className='feature-with-photo-info'>
                    ...
                    <img className='feature-img' src={streamVicData.Details.image} alt="streamvic-details" />
                </div>
                <div className='feature-no-photo'>
