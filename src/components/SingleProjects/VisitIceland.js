    ...
    return (
        <section className='single-project'>
            ...
            <div className='project-headers'>
                ...
                <MainButton link='https://traveltoiceland.netlify.app/' text='LIVE SITE' type='main-btn secondary-btn' />
            ...
            <div ref={featuresSection} className='single-project-features'>
                ...
                <div className='feature-no-photo'>
                    <h1 className='feature-h1'>{visitIcelandData.RoutesAnimation.title}</h1>
                ...
                <div className='feature-with-photo'>
                    <div className='feature-with-photo-info'>
                        <h1 className='feature-h1'>{visitIcelandData.SightsCarousel.title}</h1>
                        <p className='single-project-p'>{visitIcelandData.SightsCarousel.text}</p>
                    </div>
                    <img className='feature-img' src={visitIcelandData.SightsCarousel.image} alt="visiticeland-sightscarousel" />
                </div>
                <div className='feature-no-photo'>
                    <div className='feature-with-photo-info'>
                        <h1 className='feature-h1'>{visitIcelandData.ExploreCarousels.title}</h1>
                        <p className='single-project-p'>{visitIcelandData.ExploreCarousels.textOne}</p>
                    </div>
                </div>
                <div className='feature-with-photo'>
                    <div className='feature-with-photo-info'>
                        <h1 className='feature-h1'>{visitIcelandData.Contact.title}</h1>
                    ...
                    <img className='feature-img' src={visitIcelandData.Contact.image} alt="visiticeland-contact" />
                </div>
                <div className='feature-no-photo'>
