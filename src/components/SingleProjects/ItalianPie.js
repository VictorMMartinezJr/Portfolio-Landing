    ...
    return (
        <section className='single-project'>
            ...
            <div className='project-headers'>
                ...
                <MainButton link='https://italianpie.netlify.app/' text='LIVE SITE' type='main-btn secondary-btrn' />
            ...
            <div ref={featuresSection} className='single-project-features'>
                ...
                <div className='feature-no-photo'>
                    ...
                    <p className='single-project-p'>{italianPieData.PageTransitions.text}</p>
                </div>
                <div className='feature-with-photo'>
                    <div className='feature-with-photo-info'>
                        <h1 className='feature-h1'>{italianPieData.ScrollAnimations.title}</h1>
                        <p className='single-project-p'>{italianPieData.ScrollAnimations.textOne}</p>
                    </div>
                    <img className='feature-img' src={italianPieData.ScrollAnimations.image} alt="streamvic-pagination" />
                </div>
                <div className='feature-no-photo'>
            ...
            <ProjectImagesCarousel imageOne={italianPieData.CarouselImages.imageOne} imageTwo={italianPieData.CarouselImages.imageTwo} imageThree={italianPieData.CarouselImages.imageThree} />
            <div className='contact-div'>
                <ContactMe />
                <FaArrowAltCircleUp className="arrow-up" onClick={() => window.scrollTo(0, 0)} />
            </div>
