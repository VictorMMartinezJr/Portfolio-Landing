        ...
        <section className='skills' id='skills'>
            ...
            <div className="skills-content">
                ...
                <div className="skills-images">
                    ...
                    <div className='skills-logo-container'>
                        <img className='css-logo skills-logo' src='Portfolio-Landing/images/css.png' alt="css-logo" />
                        <p className='skills-logo-name'>CSS</p>
                    </div>
                    <div className='skills-logo-container'>
                        <img className='js-logo skills-logo' src='Portfolio-Landing/images/js.png' alt="js-logo" />
                        <p className='skills-logo-name'>JavaScript</p>
                    </div>
                    <div className='skills-logo-container'>
                        <img className='react-logo skills-logo' src='Portfolio-Landing/images/react.png' alt="react-logo" />
                ...
                <div className='softskills-logos'>
                    ...
                    <div className='skills-logo-container'>
                        <img className='react-logo skills-logo' src='Portfolio-Landing/images/github.png' alt="github-logo" />
                        <p className='skills-logo-name'>GitHub</p>
                    </div>
                    <div className='skills-logo-container'>
                        <img className='react-logo skills-logo' src='Portfolio-Landing/images/npm.png' alt="npm-logo" />
                        <p className='skills-logo-name'>NPM</p>
                    </div>
                    <div className='skills-logo-container'>
                        <img className='react-logo skills-logo' src='Portfolio-Landing/images/bootstrap.png' alt="bootstrap-logo" />
